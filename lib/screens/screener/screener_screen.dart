...
class _ScreenerScreenState extends ConsumerState<ScreenerScreen> {
  ...
  Future<void> _runScreener() async {
    ...
    try {
      ...
      if (!mounted || myVersion != _requestVersion) return;
      setState(() {
        _error = 'Failed to load screener results.';
        _loading = false;
      });
    }
  }
  ...
  Color _changeColor(double? v) => v == null
      ? _textDim
      : (v >= 0 ? const Color(0xFF26C96F) : const Color(0xFFEF4444));
      ...
      child: Row(
        children: [
          ...
          _chip(
            ...
            _signal == 'OVERSOLD',
            () => setState(() {
              _signal = _signal == 'OVERSOLD' ? null : 'OVERSOLD';
              _runScreener();
            }),
          ),
          const SizedBox(width: 6),
          _chip(
            ...
            _signal == 'OVERBOUGHT',
            () => setState(() {
              _signal = _signal == 'OVERBOUGHT' ? null : 'OVERBOUGHT';
              _runScreener();
            }),
          ),
          const SizedBox(width: 12),
                ...
                children: [
                  ...
                  Text(
                    chgPct != null
                        ...
                        : '-',
                    style: TextStyle(
                      color: _changeColor(chgPct?.toDouble()),
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ...
                if (rsi != null)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _rsiColor(rsi.toDouble()).withOpacity(0.4),
                      ),
                    ),
                    child: Text(
                      'RSI ${rsi.toStringAsFixed(0)}',
                      style: TextStyle(
                        color: _rsiColor(rsi.toDouble()),
                        fontSize: 11,
                        fontWeight: FontWeight.w600,
                      ),
                    ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Try removing the signal or sector filter.',
